"""
The SAC part of the code mainly comes from the
Soft-Actor Critic YouTube tutorial (with modifications) found at:
    ...
    def learn(self, update_params=True, update_disc=False):
        if(self.auto_entropy):
            ...
            if disc1_loss is not None and disc2_loss is not None:
                return actor_loss, disc1_loss, disc2_loss, torch.mean(disc1_log_probs).item(),\
